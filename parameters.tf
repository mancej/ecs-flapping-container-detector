resource "aws_ssm_parameter" "notification_interval" {
  name  = "/devops/lambda/flapping_detector/notification_interval"
...
resource "aws_ssm_parameter" "default_notification_channel" {
  name  = "/devops/lambda/flapping_detector/notifications/channel/default"
...
resource "aws_ssm_parameter" "default_channel_webhook" {
  name  = "/devops/lambda/flapping_detector/webhooks/channel/${aws_ssm_parameter.default_notification_channel.value}"
...
resource "aws_ssm_parameter" "recovery_period" {
  name  = "/devops/lambda/flapping_detector/recovery_period"
...
resource "aws_ssm_parameter" "start_of_business" {
  name  = "/devops/lambda/flapping_detector/start_of_business"
...
resource "aws_ssm_parameter" "end_of_business" {
  name  = "/devops/lambda/flapping_detector/end_of_business"
...
resource "aws_ssm_parameter" "sequential_start_alarm_threshold" {
  name  = "/devops/lambda/flapping_detector/sequential_start_alarm_threshold"
...
resource "aws_ssm_parameter" "suppress_flapper_action_name" {
  name  = "/devops/lambda/flapping_detector/suppress_flapper_slack_action_callback_id"
...
resource "aws_ssm_parameter" "slack_action_name" {
  name  = "/devops/lambda/flapping_detector/suppress_flapper_slack_action_name"
...
resource "aws_ssm_parameter" "alert_weekends" {
  name  = "/devops/lambda/flapping_detector/alert_weekends"
...
resource "aws_ssm_parameter" "dynamo_service_metrics_table" {
  name  = "/devops/dynamo/service_metrics_table_name"
...
resource "aws_ssm_parameter" "dynamo_service_metrics_hash_key" {
  name  = "/devops/dynamo/service_metrics_hash_key_name"
